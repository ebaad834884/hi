    ...
    public class RequestAppointmentBookingController : Controller
    {
        ...
        public async Task<JsonResult> GetAppointments()
        {
            ...
            try
            {
                ...
                logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to get ES and LS | Call to ClickCallService.cs (objCallClickService.GetESLSByStandardOperation) with Duration: " + resindextoreq.Duration);
                ...
                if (EsAndLS != null)
                {
                    logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to get ES and LS | Call to ClickCallService.cs (objCallClickService.GetESLSByStandardOperation) with Duration: " + resindextoreq.Duration + " | Call duration: " + Tx1.Milliseconds + " | Response ES and LS: " + EsAndLS.Item1 + " " + EsAndLS.Item2);
                    if ((EsAndLS.Item1 != string.Empty && EsAndLS.Item2 != string.Empty) && (EsAndLS.Item1 != EsAndLS.Item2))
                    {
                        ...
                        {
                            logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots for Installation | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation) with params: " + Convert.ToDateTime(EsAndLS.Item1).ToString("dd/MM/yyyy HH:mm") + " , " + Convert.ToDateTime(EsAndLS.Item2).ToString("dd/MM/yyyy HH:mm"));
                            ...
                            logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots for Installation | Call to ClickCallService.cs (objCallClickService.ClickCallByOperation) | Call duration: " + Tx2.Milliseconds);
                        }
                        else
                        {
                            logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation) with params: " + Convert.ToDateTime(EsAndLS.Item1).ToString() + " " + Convert.ToDateTime(EsAndLS.Item2).ToString() + " " + resindextoreq.Duration + " " + resindextoreq.profile + " " + resindextoreq.PreferredFSEs + " " + resindextoreq.FseSkillLevel + " " + IsExtendedSlots);
                            ...
                            logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots | Call to ClickCallService.cs (objCallClickService.GetESLSByStandardOperation) | Call duration: " + Tx3.Milliseconds);
                        }
                    }
                }
                ...
                if (resindextoreq.earlyStart != string.Empty && resindextoreq.lateStart != string.Empty)
                {
                    if (Session["SelectJobType"].ToString() == "Install")
                    {
                        ...
                        logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots for Installation | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation) with params: " + " " + appStart + " " + appFinish + " " + resindextoreq.Duration + " " + resindextoreq.profile + " " + resindextoreq.PreferredFSEs + " " + resindextoreq.FseSkillLevel + " " + IsExtendedSlots);
                        ...
                        logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots for Installation | Call to ClickCallService.cs (objCallClickService.ClickCallByOperation) | Call duration: " + Tx4.Milliseconds);
                    }
                    else
                    {
                        ...
                        logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation)");
                        ...
                        logger.Debug("In RequestAppointmentBooking controller GetAppointment Method to retrieve slots | Call to ClickCallService.cs (objCallClickService.ClickCallByOperation) | Call duration: " + Tx5.Milliseconds);
                    }
                }
        ...
        public JsonResult RequestAppointment(string EStart, string LStart, int Duration, string Profile, string TaskNotes, string SSOFse1, string SSOFse2, string SSOFse3, string fseSkill, string taskStatus, List<List<Array>> AddressArray, string desiredDate, string partcomments, string JobType, string IsRequiredfse)
        {
            ...
            logger.Debug("In RequestAppointmentBooking controller RequestAppointment Method to get StartTime | Call to CountriesTimeZoneConversion.cs (CountriesTimeZoneConversion.GetTimeZone) with country code and ship to site address: " + " " + Conversion.serviceRequest.countryCode + " " + Conversion.serviceRequest.shipToAddress);
            ...
            logger.Debug("In RequestAppointmentBooking controller RequestAppointment Method to get StartTime | Call to CountriesTimeZoneConversion.cs (CountriesTimeZoneConversion.GetTimeZone) | Call duration: " + Tx6.Milliseconds + " | Response: " + StartTime);
            try
            {
                ...
                //GetESLSByStandardOperation will give ES and LS dates for fetching INSLA
                logger.Debug("In RequestAppointmentBooking controller RequestAppointment Method to get ES and LS | Call to CallClickService.cs (CallClickService.GetESLSByStandardOperation) wity duration: " + Duration);
                ...
                if (EsAndLS != null)
                {
                    logger.Debug("In RequestAppointmentBooking controller RequestAppointment Method to get ES and LS | Call to CallClickService.cs (CallClickService.GetESLSByStandardOperation) | Call duration: " + Tx7.Milliseconds + " | Response: " + EsAndLS.Item1 + " " + EsAndLS.Item2);
                    if (EStart == "")
                    {
        ...
        public async Task<ActionResult> RequestExtendedSlotsTask()
        {
            ...
            try
            {
                ...
                if (resindextoreq.earlyStart != string.Empty && resindextoreq.lateStart != string.Empty)
                {
                    logger.Debug("In RequestAppointmentBooking controller RequestExtendedSlots Method to retrieve extended slots with 1 and 2 hours (3 calls) | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation)");
                    ...
                    logger.Debug("In RequestAppointmentBooking controller RequestExtendedSlots Method to retrieve extended slots with 1 and 2 hours 3 calls | Call to ClickCallService.cs (CallClickSerrvice.ClickCallByOperation) | Call duration: " + Tx8.Milliseconds);
                }
                if (inSLASlotsLists != null)
                {
                    ...
                    if ((((System.Tuple<string, string>)(ESLS)).Item1) != string.Empty && (((System.Tuple<string, string>)(ESLS)).Item2) != string.Empty)
                    {
                        if (resExtendedSlots != null && resExtendedSlots.Count() > 0)
                        {
                            ...
                            foreach (var i in resExtendedSlots)
                            {
                                ...
                                {
                                    logger.Debug("In RequestAppointmentBooking controller RequestExtendedSlots Method for Bump Check | Call to ClickCallService.cs (CallClickSerrvice.BumpCheck) | Call duration: " + Tx9.Milliseconds + " | Response: " + Convert.ToString(result));
                                    i.Bump = "Yes";
        ...
        public async Task<ActionResult> ProcessTsk(string date, string appStart, string appFinish, bool requiredFse, string isBumpTask, string Schedulingpolicy)
        {
            ...
            try
            {
                ...
                if (objIndexToRequest.addressArray != null)
                {
                    ...
                    {
                        logger.Debug("In RequestAppointmentBooking controller ProcessTsk Method for Creating Part Pick up Dependency | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency)");
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ProcessTsk Method for Creating Part Pick up Dependency | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx10.Milliseconds);
                    ...
                    else
                    {
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ProcessTsk Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.ClickCallToCreateTask) | Call duration: " + Tx11.Milliseconds + " | Response: " + Convert.ToString(resProcessTask.FirstOrDefault().Status) + " " + Convert.ToString(resProcessTask.FirstOrDefault().TaskID));
                ...
                else
                {
                    ...
                    logger.Debug("In RequestAppointmentBooking controller ProcessTsk Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.ClickCallToCreateTask) with params: " + Convert.ToString(objIndexToRequest.earlyStart) + " " + Convert.ToString(objIndexToRequest.lateStart) + " " + Convert.ToInt32(objIndexToRequest.Duration) + " " + Convert.ToString(objIndexToRequest.TaskNotes) + " " + Convert.ToString(objIndexToRequest.FseSkillLevel) + " " + Convert.ToString(objIndexToRequest.PreferredFSEs) + " " + DateTime.Parse(aStart, CultureInfo.GetCultureInfo("en-US")).ToString("dd/MM/yyyy HH:mm") + " " + DateTime.Parse(aFinish, CultureInfo.GetCultureInfo("en-US")).ToString("dd/MM/yyyy HH:mm") + " " + Convert.ToBoolean(Session["IsRequiredFse"].ToString()));
                    ...
                    logger.Debug("In RequestAppointmentBooking controller ProcessTsk Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.ClickCallToCreateTask) | Call duration: " + Tx12.Milliseconds + " | Response: " + Convert.ToString(resProcessTask.FirstOrDefault().Status) + " " + Convert.ToString(resProcessTask.FirstOrDefault().TaskID));
                    if (resProcessTask == null)
                        logger.Debug("RequestAppointmentBookingController;ProcessTsk;API Response: Process Task is NULL ");
        ...
        public async Task<ActionResult> ProcessTaskwithoutAppointment(string EStart, string LStart, int Duration, string TaskNotes, List<List<Array>> addressArray, string fseSkill, string PreferredFSEs, string partcomments, string taskOpenDate, string jobType, string IsRequiredfse)
        {
            ...
            try
            {
                if (addressArray != null)
                {
                    ...
                    {
                        logger.Debug("In RequestAppointmentBooking controller ProcessTaskwithoutAppointment Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) with params: " + objIndexToRequest.earlyStart + " " + objIndexToRequest.lateStart + " " + objIndexToRequest.Duration + " " + objIndexToRequest.TaskNotes + " " + objIndexToRequest.FseSkillLevel + " " + addressArray + " " + objIndexToRequest.PartComments + " " + objIndexToRequest.PreferredFSEs);
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ProcessTaskwithoutAppointment Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx13.Milliseconds);
                        return Json(new { message = "Success", JobType = "Part", TaskID = taskID });
                    }
                    else
                    {
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ProcessTaskwithoutAppointment Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.ClickCallToCreateTask) with params: " + objIndexToRequest.earlyStart + " " + objIndexToRequest.lateStart + " " + objIndexToRequest.Duration + " " + objIndexToRequest.TaskNotes + " " + objIndexToRequest.FseSkillLevel + " " + objIndexToRequest.PreferredFSEs);
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ProcessTaskwithoutAppointment Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx14.Milliseconds);
                ...
                else
                {
                    ...
                    logger.Debug("In RequestAppointmentBooking controller ProcessTaskwithoutAppointment Method for Creating Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx15.Milliseconds + " | Response: " + taskappointmentsSolt.FirstOrDefault().Status + " " + taskappointmentsSolt.FirstOrDefault().TaskID);
                    logger.Debug("RequestAppointmentBookingController;ProcessTaskwithoutAppointment; End");
        ...
        public ActionResult CancelTask(string CancelReason)
        {
            ...
            try
            {
                ...
                logger.Debug("In RequestAppointmentBooking controller CancelTask Method for Cancelling Task | Call to ClickCallService.cs (CallClickSerrvice.CancelTask) with cancel reason: " + CancelReason);
                ...
                logger.Debug("In RequestAppointmentBooking controller CancelTask Method for Cancelling Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx16.Milliseconds + " | Response: " + cancelStatus);
        ...
        public ActionResult ModifyVisit(string earlyStart, string lateStart, int duration, List<List<Array>> addressArray, string TaskNotes, string fseSkill, string PreferredFSEs, string JobType, string partcomments, string IsRequiredfse)
        {
            ...
            try
            {
                ...
                if (addressArray != null)
                {
                    ...
                    if (addressArray[0].Count > 0)
                    {
                        logger.Debug("In RequestAppointmentBooking controller ModifyVisit Method for Modifying Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) with params: " + objIndexToRequest.earlyStart + " " + objIndexToRequest.lateStart + " " + objIndexToRequest.Duration + " " + objIndexToRequest.TaskNotes + " " + objIndexToRequest.FseSkillLevel + " " + addressArray + " " + objIndexToRequest.PartComments + " " + PreferredFSEs);
                        ...
                        logger.Debug("In RequestAppointmentBooking controller ModifyVisit Method for Modifying Task | Call to ClickCallService.cs (CallClickSerrvice.PartPickDependency) | Call duration: " + Tx17.Milliseconds + " | Response: " + resPartPickUp);
                        //
        ...
        public ActionResult GetSlotDetails(string date, string appStart, string appFinish, bool requiredFse, string TentativeFse, string SSOID)
        {
            ...
            try
            {
                logger.Debug("In RequestAppointmentBooking controller GetSlotDetails Method to get task slots | Call to ClickCallService.cs (CallClickSerrvice.GetTasksResponse) with params: " + date + " " + appStart + " " + appFinish + " " + requiredFse + " " + TentativeFse + " " + SSOID);
                ...
                logger.Debug("In RequestAppointmentBooking controller GetSlotDetails Method to get task slots | Call to ClickCallService.cs (CallClickSerrvice.GetTasksResponse) | Call duration: " + Tx18.Milliseconds);
