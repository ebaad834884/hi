...
namespace NewSDTApplication.Controllers
{
    ...
    public class SystemController : Controller
    {
        ...
        /// <summary>
        /// Stores System Potential Dependency in ViewBag and return view.
        /// </summary>
        /// <returns></returns>
        ...
        [HttpPost]
        public JsonResult SystemDependencies(string TaskSystemID, string SystemCountActual, string EStart, string LStart, string Duration, string TaskNotes, string SRDesc,  string DependencyType,
           List<List<Array>> addressArray, string Profile, string SSOFse1, string fseSkill, string IsRequiredfse, string JobType)
        {
            try
            {
                ...
                else
                {
                    ...
                    logger.Debug("In SystemController SystemDependencies method | Start - Parameters EStart: " + EStart + ", LStart:" + LStart + " , Duration:" + Duration + " , Profile:" + Profile + " , TaskNotes:" + TaskNotes + " ~ " + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                }
            ...
            catch (Exception ex)
            {
                ...
                logger.Error("In SystemController SystemDependencies method | Exception:" + ex.Message + " ~ " + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        /// <summary>
        /// Calls GetTasksRequestByPropertyName() of ClickCallService. Gets skill level and rating.
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        public async Task<JsonResult> GetSystemDependencies()
        {
            ...
            try
            {
                ...
                logger.Debug("In Site controller GetSiteDependencies Method | Call to ClickCallService.cs (objClickCallService.GetTasksRequestByPropertyName) ~ " + IP + " ~ Request: SystemID: " + resindextoreq.TaskSystemID + " ~ Response: Task list ~ Call duration: " + Tx1.TotalMilliseconds);
            ...
            {
                logger.Error("In SystemController GetSystemDependencies method | Exception:" + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        public async Task<JsonResult> GetActualSystemDependencies()
        {
            try
            {
                ...
                logger.Debug("In Site controller GetSiteDependencies Method | Call to ClickCallService.cs (objClickCallService.GetTasksRequestByPropertyName) ~ " + IP + " ~ Request:  SystemID: " + resindextoreq.TaskSystemID + " ~ Response: Task List based on a System ID ~ Call duration: " + Tx2.TotalMilliseconds);
        ...
        public async Task<ActionResult> CreateVisitWithDependencies(string FinalRes)
        {
            try
            {
                ...
                logger.Debug("In Site controller GetSiteDependencies Method | Call to ClickCallService.cs (objClickCallService.GetTasksRequestByPropertyName) ~ " + IP + " ~ Request: With json containing tasks list ~ Response: " + createStatus + " ~ Call duration: " + Tx3.TotalMilliseconds);
