...
namespace NewSDTApplication.Utilities
{
    public class CallClickSerrvice
    {
        ...
        /// <summary>
        /// Calls the ScheduleService and returns the task details. 
        /// </summary>
        ...
        {
            logger.Debug("In CallClickSerrvice.cs GetTasksRequestByPropertyName method | Start" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            //US156-Implementing indexing mechanism starts  
            //Implementing indexing mechanism for the Task properties TaskSystemID,TaskSiteID,MUSTJobNumber,TaskID instead of dynamic grouping for faster retrieval of data    
            //the properties TaskRfsNumber and TaskActivityID are not present in the task object of the SB1
            if ((propertyName == "TaskRfsNumber" || propertyName == "TaskActivityID") || (propertyName == "TaskSystemID" && (propValue == "" || propValue == null)))  //DE171 Code-using dynamic grouping instead of indexing when system id is null/empty to avoid code exceptions
            {
                getTasksRequest.EnableGroupOnTheFly = true;
                getTasksRequest.Group = new NewSDTApplication.ScheduleServiceDev1.Group();
                getTasksRequest.Group.GroupParameters = new string[] { propValue };
            ...
            {
                List<ScheduleServiceDev1.IndexesIndex> indexesIndexs = new List<ScheduleServiceDev1.IndexesIndex>();
                ScheduleServiceDev1.IndexesIndex indexesIndex = new ScheduleServiceDev1.IndexesIndex();
                indexesIndex.LowBound = new ScheduleServiceDev1.Property[1] { new ScheduleServiceDev1.Property() { Name = propertyName, Value = new ScheduleServiceDev1.KeyValue() { Value = propValue } } };
                indexesIndex.HighBound = indexesIndex.LowBound;
                indexesIndexs.Add(indexesIndex);
                getTasksRequest.Indexes = new NewSDTApplication.ScheduleServiceDev1.Indexes() { Index = indexesIndexs.ToArray(), Distinct = false, DistinctSpecified = false };
            }
            // US156-Implementing indexing mechanism ends
            ...
            logger.Debug("In CallClickSerrvice.cs GetTasksRequestByPropertyName method | End" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");

            return objGetTasksResponse;
        }

        /// <summary>
        /// Makes call to ServiceOptimizationService and returns Early start and Late Start.
        /// </summary>
        ...
        public Tuple<string, string> GetESLSByStandardOperation(int duration)
        {
            ...
            logger.Debug("In CallClickSerrvice.cs GetESLSByPropertyName | Start" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            try
            {
                OpenConnectionToSDT();
                ...
                logger.Debug("In CallClickSerrvice.cs GetESLSByStartdardOperation method | ExecuteOperation System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                CloseConnectionSDT();
                return dates;
            }
            catch (Exception ex)
            {
                logger.Error("In CallClickSerrvice.cs GetESLSByPropertyName method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                return null;
            }
        }

        /// <summary>
        /// Opens SDT connection.
        /// </summary>
        /// <returns></returns>
        public bool OpenConnectionToSDT()
        {
            try
            {
                logger.Debug("In CallClickSerrvice.cs OpenConnectionToSDT method | Start" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                ...
                if (ScheduleService == null || ScheduleService.State == CommunicationState.Closed || ScheduleService.State == CommunicationState.Faulted)
                {
                    ...
                    basicHttpBindingscheduleService.SendTimeout = new System.TimeSpan(0, 10, 0);
                    basicHttpBindingscheduleService.OpenTimeout = new System.TimeSpan(0, 20, 0);
                    basicHttpBindingscheduleService.CloseTimeout = new System.TimeSpan(0, 20, 0);
                    basicHttpBindingscheduleService.ReceiveTimeout = new System.TimeSpan(0, 20, 0);
                ...
                if ((ServiceOptimizationService == null) || (ServiceOptimizationService.State == CommunicationState.Faulted) || (ServiceOptimizationService.State == CommunicationState.Closed))
                {
                    ...
                    // basicHttpBindingserviceOptimizationService.SendTimeout = new System.TimeSpan(0, 2, 0);
                    basicHttpBindingserviceOptimizationService.SendTimeout = new System.TimeSpan(0, 10, 0);
                    basicHttpBindingserviceOptimizationService.OpenTimeout = new System.TimeSpan(0, 10, 0);
                    basicHttpBindingserviceOptimizationService.CloseTimeout = new System.TimeSpan(0, 10, 0);
                    basicHttpBindingserviceOptimizationService.ReceiveTimeout = new System.TimeSpan(0, 10, 0);
                ...
                logger.Debug("In CallClickSerrvice.cs OpenConnectionToSDT method | End" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            {
                logger.Error("CallClickSerrvice.cs OpenConnectionToSDT method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        public void CloseConnectionSDT()
        {
            ...
            {
                logger.Error("In CallClickSerrvice.cs CloseConnectionSDT | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        /// <summary>
        /// Calls the ServiceOptimizationService to get the travel time.
        /// </summary>
        ...
        public long GetTravelTimeWithKeys(int SourceKey, int DestinationKey)
        {
            ...
            {
                logger.Error("In CallClickSerrvice.cs GetTravelTimeWithKeys method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                CloseConnectionSDT();
                return returnValue;
            }
        }
        ...
        /// <summary>
        /// Make Call to ScheduleService to create task in Click. 
        /// </summary>
        ...
        /// <returns></returns>
        /// //Jayesh Soni - US82 - 13/04/2017 - Parameter Added
        public async Task<IEnumerable<AppointmentSlots>> ClickCallToCreateTask(string earlystart, string latestart, int duration, string TaskNotes, string fseSkill, string PreferredFSEs, string srDescription, string AppStart = "", string AppFinish = "", bool RequiredFSE = false)
        {

            logger.Debug("In CallClickSerrvice.cs ClickCallToCreateTask method | Sessiondata: Task StartDate: " + earlystart + ", Duration: " + duration + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            try
            {
                ...
                # region deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code in snippet was used to assign bump flag to the session variable)
                ...
                //    }
                //}
                # endregion deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code in snippet was used to assign bump flag to the session variable)
               ...
               task.OpenDateSpecified = true;
                ...
                task.SRDescription = srDescription;
                ...
                System.TimeSpan span = endTime.Subtract(startTime);
                logger.Debug("In CallClickSerrvice.cs ClickCalltoCreateTask(Create Task) method | ProcessTaskExAsync System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                CloseConnectionSDT();
            ...
            {
                logger.Error("In CallClickSerrvice.cs  ClickCallToCreateTask method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                //DateTime endTime = DateTime.Now;

                //System.TimeSpan span = endTime.Subtract(startTime);
                //logger.Debug("CallClickSerrvice.cs;ClickCalltoCreateTask(Create Task):ProcessTaskExAsync System.TimeSpan in Sec ;" + span.Seconds);
        ...
        /// <summary>
        /// Make call to CountriesTimeZoneConversion to convert the time as per the timezone of region. Returns the appointment slots list.
        /// </summary>
        /// <param name="earlystart"></param>
        /// <param name="latestart"></param>
        /// <param name="duration"></param>
        ...
        /// <param name="preferredFSEs"></param>
        /// <param name="fseSkillLevel"></param>
        /// <param name="IsExtendedSlots"></param>
        /// <param name="ExtendedSlotsType"></param>
        /// <returns></returns>
        public async Task<IEnumerable<AppointmentSlots>> ClickCallByOperation(string earlystart, string latestart, int duration, string profile, string preferredFSEs, string fseSkillLevel, bool IsExtendedSlots, string ExtendedSlotsType)
        {
            ...
            try
            {
                ...
                //if (res.serviceRequest.srType != "Corrective Repair" && res.serviceRequest.gEMSEntitlementFlag != "Y")
                //{
                //Code changes by Ebaad  22/3/2017 for US134
                objCountriesTimeZoneConversion = new CountriesTimeZoneConversion();
                tzConversion = objCountriesTimeZoneConversion.GetTimeZone(res.serviceRequest.countryCode, res.serviceRequest.shipToAddress);            
                if (string.IsNullOrEmpty(earlystart))
                {
                    //Code changes by Ebaad  22/3/2017 for US134
                    period.Start = tzConversion;
                }
                else
                {
                    if (res.serviceRequest.srType == "Installation")
                   ...
                   //Code changes by Ebaad  22/3/2017 for US134
                    period.Start = edt < tzConversion ? tzConversion : edt;               
                }
                ...
                else
                {
                    ...
                    //Code changes by Ebaad  22/3/2017 for US134
                    period.Finish = ldt < tzConversion ? period.Start.AddDays(3) : ldt;
                }
                //}
               ...
               task.OpenDateSpecified = true;
                ...
                if (task.EarlyStartSpecified == false && task.LateStartSpecified == false)
                {
                    ...
                    System.TimeSpan span = endTime.Subtract(startTime);
                    logger.Debug("In CallClickSerrvice.cs ClickCallByOperation(Request Appointment) method | ExtendedGetAppointmentsEx2Async System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                ...
                else
                {
                    ...
                    for (int i = 0; i <= split; i++)
                    {
                        ...
                        if (IsExtendedSlots)
                        {
                            # region deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to Allow Unscheduling the tasks in SDT Schedule for Bumping)
                            ...
                            //}
                            # endregion deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to Allow Unscheduling the tasks in SDT Schedule for Bumping)
                        ...
                        # region deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to retrive extended slots for Bumping tasks in Extended slots as well as for Normally retrieving extended slots)
                        ...
                        # endregion deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to retrive extended slots for Bumping tasks in Extended slots as well as for Normally retrieving extended slots)
                        ...
                        System.TimeSpan span = endTime.Subtract(startTime);
                        logger.Debug("In CallClickSerrvice.cs ClickCallByOperation(Request Appointment) | ExtendedGetAppointmentsEx2Async System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            {
                logger.Error("In CallClickService.cs ClickCallByOperation method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                //DateTime endTime = DateTime.Now;

                //System.TimeSpan span = endTime.Subtract(startTime);
                //logger.Debug("CallClickSerrvice.cs;ClcikcallByOperation(Request Appointment):ExtendedGetAppointmentsEx2Async System.TimeSpan in Sec ;" + span.Seconds);
        ...
        /// <summary>
        /// Modifies the visit by calling ProcessTaskEx() & returns boolean value 'True' if visit is modified. 
        /// </summary>
        /// <param name="EarlyStart"></param>
        /// <param name="LateStart"></param>
        /// <param name="Duration"></param>
        ...
        /// <param name="TaskNotes"></param>
        /// <param name="fseSkills"></param>
        /// <param name="PreferredFSEs"></param>
        /// <returns></returns>
        /// //Jayesh Soni - US82 - 13/04/2017 - Parameter added
        public bool ModifyVisit(string EarlyStart, string LateStart, int Duration, int Number, string TaskNotes, string fseSkills, string PreferredFSEs, string srDescription)
        {
            logger.Debug("In CallClickSerrvice.cs ModifyVisit method | Session data: Task StartDate: " + EarlyStart + ", Duration: " + Duration + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            try
            {
                if (HttpContext.Current.Session["TaskResponseByTask"] != null)
                {
                    ...
                    processTaskExRequest.Task.SRDescription = srDescription;
                    ...
                    System.TimeSpan span = endTime.Subtract(startTime);
                    logger.Debug("In CallClickService.cs CreateTaskWithDependencies method | ExecuteMultipleOperations System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                    return true;
                }
                else
                    return false;
            ...
            catch (Exception ex)
            {
                ...
                //System.TimeSpan span = endTime.Subtract(startTime);
                //logger.Debug("CallClickSerrvice.cs;CreateTaskWithDependencies:ExecuteMultipleOperations System.TimeSpan in Sec ;" + span.Seconds);

                logger.Error("In CallClickService.cs ModifyVisit method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                CloseConnectionSDT();
                throw;
            }
        }
        ...
        /// <summary>
        /// Cancels the task created in SDT.
        /// </summary>
        ...
        public bool CancelTask(string CancelReason)
        {
            ...
            try
            {
                if (HttpContext.Current.Session["TaskResponseByTask"] != null)
                {
                    ...
                    if (taskStatusvalue == "Acknowledged" || taskStatusvalue == "Assigned")
                    {
                        ...
                        System.TimeSpan span = endTime.Subtract(startTime);
                        logger.Debug("In CallClickService.cs CancelTask method | ProcessTaskEx System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                        logger.Debug("In CallClickService.cs CancelTask method | Rejected Status set Successfully" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                    ...
                    processTaskExRequest.ReturnSchedulingError, out processTaskExResponse.LinkedTasks, out processTaskExResponse.SchedulingError);
                        ...
                        System.TimeSpan span1 = endTime1.Subtract(startTime1);
                        logger.Debug("In CallClickSerrvice.cs CancelTask method | ProcessTaskEx System.TimeSpan in Sec: " + span1.Minutes * 60 + span1.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                        logger.Debug("In CallClickSerrvice.cs CancelTask method | Cancel status set successfully" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                    ...
                    processTaskExRequest.ReturnSchedulingError, out processTaskExResponse.LinkedTasks, out processTaskExResponse.SchedulingError);
                        ...
                        System.TimeSpan span2 = endTime2.Subtract(startTime2);
                        logger.Debug("In CallClickService.cs CancelTask method | ProcessTaskEx System.TimeSpan in Sec ;" + span2.Minutes * 60 + span2.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                        logger.Debug("In CallClickService.cs CancelTask method | End - Return True" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                ...
                {
                    logger.Debug("In CallClickService.cs CancelTask method | End - Return False" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            {
                logger.Error("In CallClickService.cs CancelTask method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        {
            logger.Debug("In CallClickService.cs IsTaskCancellable | Start" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            logger.Debug("In CallClickSerrvice.cs IsTaskCancellable method | End" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");

            return true;
        }

        /// <summary>
        /// Calls ServiceOptimizationService to get the System details from Click.
        /// </summary>
        ...
        public ServiceOptimizationService.GEHCSystem GetSystemDetails(string SystemId)
        {
            ...
            catch (FaultException ex)
            {
                ...
                logger.Error("In CallClickService.cs GetSystemDetails method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                // CloseConnectionSDT();
                return null;
            }
            catch (Exception ex)
        ...
        /// <summary>
        /// Calls ServiceOptimizationService to get the specific Engineer's name.
        /// </summary>
        ...
        public ServiceOptimizationService.Engineer[] GetResources(string name, string value)
        {
            ...
            {
                logger.Error("In CallClickSerrvice.cs GetResources method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
        ...
        /// <summary>
        /// Calls ServiceOptimizationService to get the site details from Click.
        /// </summary>
        ...
        public ServiceOptimizationService.GEHCSite GetSiteDetails(string SiteID)
        {
            ...
            {
                // Implement Logger correctly
                logger.Error("In CallClickService.cs GetSiteDetails method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                // CloseConnectionSDT();
                //throw ex;
                return null;
            }
            ...
            {
                // Implement Logger correctly
                logger.Error("In CallClickSerrvice.cs GetSiteDetails method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                // CloseConnectionSDT();
                //throw ex;
                return null;
            }
        ...
        /// <summary>
        /// Calls ServiceOptimizationService to get the Date dtails of the specified System ID.
        /// </summary>
        /// <param name="SystemID"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Calls GetTasksRequestByPropertyName to get the task number for the passed parameter in method and returns TaskNumber + 1
        /// </summary>
        ...
        public async Task<string> CreateTaskWithDependencies(List<CustomTasksList> TaskData)
        {
            ...
            if (TaskData.Count > 0)
            {
                ...
                //Jayesh Soni - US82 - 13/04/2017 Added - Start
                //srDescription=TaskData[0].SRDescription;
                //Jayesh Soni - US82 - 13/04/2017 End
            }
            ...
            try
            {
                ...
                ////Jayesh Soni - US82 - 13/04/2017 Start
                //objSiebelTask.SRDescription = srDescription;
                //Jayesh Soni - US82 - 13/04/2017 End
                ...
                if (res.serviceRequest.srType == "Installation")
                {
                    ...
                    {
                        //Code changes by Ebaad  22/3/2017 for US134
                        objSiebelTask.EarlyStart = tzConversion;
                        objSiebelTask.EarlyStartSpecified = true;
                    }
                    ...
                    {
                        //Code changes by Ebaad  22/3/2017 for US134
                        objSiebelTask.LateStart = tzConversion.AddDays(10);
                        objSiebelTask.LateStartSpecified = true;
                    }
                ...
                objSiebelTask.SRDescription = ((IndextoRequest)HttpContext.Current.Session["IndextoRequest"]).SRDescription;
                ...
                ////Jayesh Soni - US82 - 13/04/2017 Start
                //ObjDependencyTask.SRDescription = srDescription;
                //Jayesh Soni - US82 - 13/04/2017 End
                ...
                System.TimeSpan span = endTime.Subtract(startTime);
                logger.Debug("In CallClickSerrvice.cs CreateTaskWithDependencies method | ExecuteMultipleOperations System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            {
                logger.Error("In CallClickService.cs CreateTaskWithDependencies | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                //return false;
                //DateTime endTime = DateTime.Now;
        ...
        public async Task<string> CreateTaskWithSystemDependencies(List<CustomTasksList> TaskData)
        {
            ...
            try
            {
                ...
                System.TimeSpan span = endTime.Subtract(startTime);
                logger.Debug("In CallClickService.cs CreateTaskWithSystemDependencies method | ExecuteMultipleOperations System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                return "Success";
            }
            catch (Exception ex)
            {
                logger.Error("In CallClickService.cs CreateTaskWithSystemDependencies method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                DateTime endTime = DateTime.Now;
        ...
        /// <summary>
        /// Make call to ServiceOptimizationService to create Part pickup dependency.
        /// </summary>
        /// <param name="earlystart"></param>
        /// <param name="latestart"></param>
        /// <param name="duration"></param>
        ...
        /// <returns></returns>
        /// //Jayesh Soni - US82 - 13/04/2017 Parameter Added
        public bool PartPickDependency(string earlystart, string latestart, int duration, string TaskNotes, string fseSkill, List<List<Array>> AddressArray, string partComments, string PreferredFSEs, string srDescription, string AppStart = "", string AppFinish = "")
        {

            TrasformSiebelToClick objSiebelToClick = new TrasformSiebelToClick();

            logger.Debug("In CallClickService.cs PartPickDependency method | Start" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            logger.Debug("In CallClickService.cs PartPickDependency method | Session Data Task StartDate: " + earlystart + ", Duration: " + duration + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            logger.Debug("In CallClickService.cs PartPickDependency method | ArrayAddressCount:" + AddressArray[0].Count + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            ...
            logger.Debug("In CallClickService.cs PartPickDependency method | CallID:" + CallID + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
            OpenConnectionToSDT();
            ServiceOptimizationService.ExecuteMultipleOperationsRequest multipleOPeration = new ServiceOptimizationService.ExecuteMultipleOperationsRequest();
            NewSDTApplication.ServiceOptimizationService.GEHCJobComments jobComments = new NewSDTApplication.ServiceOptimizationService.GEHCJobComments();
            try
            {
                ...
                for (int j = 0; j < list.Count; j++)
                {
                    ...
                    processTaskExRequest.RelatedTasks[j].MacroVersion = "1";
                    // Convert.ToString(objCountriesTimeZoneConversion.GetTimeZone(res.serviceRequest.countryCode, res.serviceRequest.shipToAddress));
                    processTaskExRequest.RelatedTasks[j].Number = j + 2;
                    processTaskExRequest.RelatedTasks[j].NumberSpecified = true;
                    //SR Description Jayesh Soni
                    //processTaskExRequest.RelatedTasks[j].SRDescription = srDescription;
                    ...
                    //HttpContext.Current.Session["partPick"]
                    //if (!string.IsNullOrEmpty(earlystart))
                    //{
                    //    if (res.serviceRequest.srType == "Installation")
                    //    {
                    ...
                    if (addressArray[4] == "KOREA REPUBLIC OF")
                    {
                        ...
                        logger.Debug("In CallClickService.cs PartPickDependency method | CountryID:" + CountryIDKO + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                    }
                    else
                    {
                        ...
                        ObjDependencyTask.CountryID = CountryRefernce;
                        logger.Debug("In CallClickService.cs PartPickDependency method | CountryID:" + addressArray[4] + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                    }
                    ...
                    logger.Debug("In CallClickService.cs PartPickDependency method | SystemID:" + SystemReference1.ID + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                ...
                //TAke Call ID from parameter Passed// (Selected Site Parameter from Site DEpendency Grid)
                objSiebelTask.CallID = CallID;
                # region deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to set the SuperPowerTaskFlag for Bumping Part Pick Up task on Gantt)
                ...
                //    }
                //}
                # endregion deprecation of Bump Check mechanism - US197 - 7/4/2017 by Ebaad (This code was used to set the SuperPowerTaskFlag for Bumping Part Pick Up task on Gantt)
                ...
                System.TimeSpan span = endTime.Subtract(startTime);
                logger.Debug("In CallClickService.cs PartpickDependency method | ExecuteMultipleOperations System.TimeSpan in Sec: " + span.Minutes * 60 + span.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                ...
                processTaskExRequest.Task.MacroVersion = "1";
                //Convert.ToString(objCountriesTimeZoneConversion.GetTimeZone(res.serviceRequest.countryCode, res.serviceRequest.shipToAddress));
                processTaskExRequest.Task.Number = 1;
                processTaskExRequest.Task.NumberSpecified = true;
                //SRDescription Jayesh Soni
                //processTaskExRequest.Task.SRDescription = srDescription;
                ...
                System.TimeSpan span1 = endTime1.Subtract(startTime1);
                logger.Debug("In CallClickService.cs PartpickDependency method | ProcessTaskExAsync System.TimeSpan in Sec: " + span1.Minutes * 60 + span1.Seconds + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                logger.Debug("In CallClickService.cs PartPickDependency method | Result : Success" + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                return true;

            }
            catch (Exception ex)
            {
                logger.Error("In CallClickService.cs PartPickDependency method | Exception: " + ex.Message + "~" + IP);
                throw;
            }
        ...
        public List<EngineerScheduleAppointment> GetTasksResponse(string date, string appStart, string appFinish, bool requiredFse, string TentativeFse, string SSOID)
        {
            ...
            {
                logger.Error("In CallClickSerrvice.cs GetResourseDetails method | Exception: " + ex.Message + "~" + IP + "~ Request : NA ~ Response : NA ~ Call Duration : NA ");
                return ObjEngineerList;
            }
        }

        # region deprecation of Bump Check method - US197 - 7/4/2017 by Ebaad (This function was iteratively called from the Request appointment booking controller for every slot retrieved from SDT Schedule)
        ...
        public ServiceOptimizationService.GEHCContract GetContractDetails(string SystemId, string srOpened)
        {
            OpenConnectionToSDT();
            try
            {
                if (string.IsNullOrEmpty(SystemId)) return null;
                NewSDTApplication.ServiceOptimizationService.GetObjectsRequest objRequest = new NewSDTApplication.ServiceOptimizationService.GetObjectsRequest();
                objRequest.OptionalParameters = new NewSDTApplication.ServiceOptimizationService.OptionalParameters() { CallerIdentity = "MUST", ErrorOnNonExistingDictionaries = true };
                List<NewSDTApplication.ServiceOptimizationService.IndexesIndex> indexesIndexs = new List<NewSDTApplication.ServiceOptimizationService.IndexesIndex>();
                NewSDTApplication.ServiceOptimizationService.IndexesIndex indexesIndex = new NewSDTApplication.ServiceOptimizationService.IndexesIndex();
                indexesIndex.LowBound = new NewSDTApplication.ServiceOptimizationService.Property[1] { new NewSDTApplication.ServiceOptimizationService.Property() { Name = "SystemID", Value = new NewSDTApplication.ServiceOptimizationService.KeyValue() { Value = SystemId } } };
                indexesIndex.HighBound = indexesIndex.LowBound;
                indexesIndexs.Add(indexesIndex);
                objRequest.Indexes = new NewSDTApplication.ServiceOptimizationService.Indexes() { Index = indexesIndexs.ToArray() };
                NewSDTApplication.ServiceOptimizationService.BaseObject[] obj = new NewSDTApplication.ServiceOptimizationService.BaseObject[] { };
                NewSDTApplication.ServiceOptimizationService.GEHCContract clickContract = new NewSDTApplication.ServiceOptimizationService.GEHCContract();

                obj = ServiceOptimizationService.GetObjects(objRequest.OptionalParameters, "GEHCContract", objRequest.Indexes, objRequest.Group, objRequest.EnableGroupOnTheFly, objRequest.KeySet, objRequest.RequestedProperties);

                if (obj != null)
                {
                    if (obj.Count() > 0)
                    {
                        foreach (NewSDTApplication.ServiceOptimizationService.BaseObject baseObj in obj)
                        {
                            clickContract = (NewSDTApplication.ServiceOptimizationService.GEHCContract)(baseObj);

                            if (clickContract != null)
                            {
                                //For filtering Inactive Contract objects
                                if (clickContract.Status.Equals("Active"))
                                {
                                    //Compare if the SR open date from Siebel is 
                                    //between contractstart and contractfinish of the Contract object.
                                    DateTime srOpenedDate = Convert.ToDateTime(srOpened);
                                    int contractStart = srOpenedDate.CompareTo(clickContract.ContractStart.Date);
                                    int contractFinish = srOpenedDate.CompareTo(clickContract.ContractFinish.Date);

                                    if (contractStart > 0 && contractFinish < 0)
                                    {
                                        return clickContract;
                                    }
                                }
                            }
                        }
            ...
            {
                // Implement Logger correctly
                logger.Error("CallClickSerrvice.cs;GetContractDetails; Exception: " + ex.Message);
                return null;
            }
            catch (Exception ex)
            {
